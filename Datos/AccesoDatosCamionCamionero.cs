...
namespace Datos
{
    class AccesoDatosCamionCamionero
    {
        ...
        public int InsertCamionCamionero(int id_camion, string matricula, int tipo, int potencia)
        {
            SqlCommand cmd = MetodoDatos.CrearComando();
            cmd.CommandText = "insert into Camion_Camionero (Id_Camion, Matricula, Tipo, Potencia) values (@id_camion, @matricula, @tipo, @potencia)";
        ...
        public int UpdateCamionCamionero(int id_camion, string matricula, int tipo, int potencia)
        {
            SqlCommand cmd = MetodoDatos.CrearComando();
